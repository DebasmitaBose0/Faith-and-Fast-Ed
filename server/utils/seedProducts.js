...
const sampleProducts = [
  // Men's Products
  {
    ...
    description:
      'Premium quality denim shirt, perfect for casual and semi-formal wear. Lightweight, breathable cotton blend with custom metal buttons.',
    price: 1599,
    ratings: 4.5,
    category: 'MEN',
    subcategory: 'Shirts',
    ...
    images: [
      {
        public_id: 'denim_shirt_1',
        url: 'https://images.unsplash.com/photo-1541101767792-f9b2b1c4f127?w=500',
      },
    ],
    numOfReviews: 12,
  ...
  },
  {
    ...
    description:
      'Extremely comfortable stretch chino trousers made of organic cotton. Available in neutral tones.',
    price: 2499,
    ratings: 3.8,
    category: 'MEN',
    subcategory: 'Pants',
  ...
  },
  {
    ...
    description:
      'Handcrafted full-grain leather messenger bag with multiple compartments. Fits up to a 15-inch laptop.',
    price: 4999,
    ratings: 4.8,
    category: 'MEN',
  ...
  // Women's Products
  {
    ...
    description:
      'Flowy floral printed maxi dress with side slit. Ideal for beach parties, vacations, and summer outings.',
    price: 1899,
    ratings: 4.6,
    category: 'WOMEN',
    subcategory: 'Dresses',
  ...
  },
  {
    ...
    description:
      'Stylish slim-fit ribbed crop top. Highly stretchable fabric that hugs your curves perfectly.',
    price: 799,
    ratings: 4.2,
    category: 'WOMEN',
    subcategory: 'Tops',
    ...
    images: [
      {
        public_id: 'crop_top_1',
        url: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=500',
      },
    ],
    numOfReviews: 24,
  ...
  },
  {
    ...
    description:
      'A-line high-waisted pleated tennis skirt. Lightweight and comes with built-in safety shorts.',
    price: 1299,
    ratings: 4.0,
    category: 'WOMEN',
    subcategory: 'Skirts',
    ...
    images: [
      {
        public_id: 'pleated_skirt_1',
        url: 'https://images.unsplash.com/photo-1583496661160-fb5886a0aaaa?w=500',
      },
    ],
    numOfReviews: 8,
  ...
  // Kids
  {
    ...
    description:
      'Super soft 100% cotton dungarees for kids. Includes a striped t-shirt and adjustable denim dungaree shorts.',
    price: 999,
    ratings: 4.4,
    category: 'KIDS',
    subcategory: 'KIDS',
    ...
    images: [
      {
        public_id: 'kids_dungaree_1',
        url: 'https://images.unsplash.com/photo-1519457431-44ccd64a579b?w=500',
      },
    ],
    numOfReviews: 4,
  ...
  // Clothing
  {
    ...
    description:
      'Heavyweight 100% organic cotton crewneck tee. Pre-shrunk fabric with double-stitched sleeves and hem.',
    price: 499,
    ratings: 4.7,
    category: 'CLOTHING',
  ...
  },
  {
    ...
    description:
      'Ultra-cozy brushed fleece oversized hoodie. Keeps you warm in premium comfort and style.',
    price: 2199,
    ratings: 4.9,
    category: 'CLOTHING',
  ...
  // Footwear
  {
    ...
    description:
      'Breathable mesh running sneakers with advanced air-bubble cushion. Designed for ultimate performance and comfort.',
    price: 3499,
    ratings: 4.3,
    category: 'FOOTWEAR',
  ...
  },
  {
    ...
    description:
      'Sophisticated formal oxford dress shoes handcrafted from genuine Italian calfskin leather.',
    price: 5999,
    ratings: 4.5,
    category: 'FOOTWEAR',
  ...
  // Seasonal
  {
    ...
    description:
      'Heavy winter parka packed with sustainable duck down. Water-resistant, windproof, and rated down to -15°C.',
    price: 7999,
    ratings: 4.7,
    ...
    images: [
      {
        public_id: 'winter_jacket_1',
        url: 'https://images.unsplash.com/photo-1544923246-77307dd654cb?w=500',
      },
    ],
    numOfReviews: 20,
  ...
  // Special
  {
    ...
    description:
      'Slim-fit structured business blazer. Crafted from high-grade wool blend for a crisp, polished professional look.',
    price: 4599,
    ratings: 4.1,
...
const seedProducts = async () => {
  try {
    ...
    console.log(
      `Seeded ${createdProducts.length} sample products successfully!`
    );
